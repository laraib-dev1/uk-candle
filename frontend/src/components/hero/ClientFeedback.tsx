...
const ClientFeedback: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden py-16 bg-gradient-to-r from-[#f9ede6] to-[#fef9f7]">
      ...
      {/* Carousel container with arrows positioned outside */}
      <div className="relative max-w-7xl mx-auto">
        {/* Left Arrow - Half outside */}
        <button
          aria-label="Scroll left"
          onClick={() => scroll("left")}
          className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 z-20 p-2 rounded-full bg-white shadow-md hover:bg-gray-100"
        >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 z-20 p-2 rounded-full bg-white shadow-md hover:bg-gray-100"
        >
