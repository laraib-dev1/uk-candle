    ...
    <section className="py-0 bg-gray-200">
      {fullWidthText ? (
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 items-center">
          ...
          <div className={`${imagePosition === "left" ? "order-2 md:order-1" : "order-1"} w-full max-w-8xl mx-auto ${spacing.container.paddingSectionAlign} ${spacing.inner.gapTop} ${spacing.inner.gapBottom} flex flex-col justify-center`}>
